...
let JSHandle = (() => {
    ...
    var JSHandle = class {
        ...
        /** @internal */
        [(_getProperty_decorators = [(0, decorators_js_1.throwIfDisposed)()], _getProperties_decorators = [(0, decorators_js_1.throwIfDisposed)()], disposablestack_js_1.Symbol.dispose)]() {
