...
export declare abstract class Browser extends EventEmitter<BrowserEvents> {
    ...
    /* Excluded from this release type: [Symbol.dispose] */
...
/* Excluded from this release type: CDPSessionEvent */
...
export declare interface CDPSessionEvents extends CDPEvents, Record<EventType, unknown> {
    ...
    /* Excluded from this release type: [CDPSessionEvent.SessionAttached] */
    /* Excluded from this release type: [CDPSessionEvent.SessionDetached] */
}
